...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>OMG HUB chào ae<Color=/>"):Display()
    wait(.5)
...
local Window = OrionLib:MakeWindow({Name = "OMG HUB", HidePremium = false, IntroText = "OMG HUB⚜️", SaveConfig = true, ConfigFolder = "NightHub"})
...
W:AddLabel("OMG HUB SCRIPT")
W:AddLabel("DiscordOMG HUB")
local Section = W:AddSection({
    Name = "Status"
})
